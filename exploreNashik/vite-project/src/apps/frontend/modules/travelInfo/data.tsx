...
export const travelInfo = {
  howToReach: {
    byAir: {
      icon: "✈️",
      options: [
        { from: "mumbaiAirport", distance: "165 km", time: "3h" },
        { from: "nashikOzarAirport", distance: "24 km from city", time: "45min" },
        { from: "puneAirport", distance: "220 km", time: "4h" },
      ],
    },
    byRail: {
      icon: "🚂",
      options: [
        { from: "mumbai", distance: "185 km", time: "3-4h", trains: "panchavatiTapovan" },
        { from: "pune", distance: "220 km", time: "4.5h", trains: "multipleExpress" },
        { from: "delhi", distance: "1,400 km", time: "18-22h", trains: "rajdhaniKerala" },
        { from: "hyderabad", distance: "575 km", time: "10-12h", trains: "multipleOptions" },
      ],
    },
    byRoad: {
      icon: "🚗",
      options: [
        { from: "mumbai", distance: "165 km", time: "3h", bus: "shivneriAc" },
        { from: "pune", distance: "210 km", time: "3.5-4h", bus: "msrtcPrivate" },
        { from: "aurangabad", distance: "105 km", time: "2h", bus: "regularMsrtc" },
        { from: "shirdi", distance: "87 km", time: "1.5-2h", bus: "regularBuses" },
      ],
    },
  },
  localTransport: [
    { key: "autoRickshaw", icon: "🛺", avgCost: "₹20-100" },
    { key: "cityBus", icon: "🚌", avgCost: "₹10-25" },
    { key: "appCab", icon: "🚕", avgCost: "₹100-400" },
    { key: "rentedBike", icon: "🏍️", avgCost: "₹300-600" },
    { key: "cycleRickshaw", icon: "🚲", avgCost: "₹20-60" },
    { key: "taxiDayHire", icon: "🚗", avgCost: "₹1,500-3,000" },
  ],
  distancesFromNashik: [
    { key: "mumbai", distance: "165 km", time: "3h" },
    { key: "pune", distance: "210 km", time: "3.5h" },
    { key: "shirdi", distance: "87 km", time: "1.5h" },
    { key: "aurangabad", distance: "105 km", time: "2h" },
    { key: "trimbakeshwar", distance: "28 km", time: "45min" },
    { key: "saptashringi", distance: "65 km", time: "1.5h" },
    { key: "igatpuri", distance: "48 km", time: "1h" },
    { key: "dhule", distance: "119 km", time: "2h" },
  ],
  bestTimeToVisit: {
    seasons: [
      { key: "winter", icon: "❄️" },
