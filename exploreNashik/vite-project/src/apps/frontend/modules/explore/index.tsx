...
//     if (selectedSub) {
//   result = result.filter(
//     (place) => place.subcategory === selectedSub
//   );
// }
...
//     if (selectedMain !== "all") {
//   result = result.filter(
//     (place) => place.category === selectedMain
//   );
// }
...
//               }}
//               className={`flex items-center gap-1.5 px-4 py-2 rounded-full text-sm whitespace-nowrap font-medium transition-all ${selectedMain === cat.id
//                 ? "bg-black text-white shadow"
//                 : "bg-white text-gray-700 border border-gray-200 hover:border-gray-400"
//                 }`}
//             >
...
//                 className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs whitespace-nowrap transition-all ${selectedSub === sub.id
//                   ? "bg-green-700 text-white shadow"
//                   : "bg-green-50 text-green-800 border border-green-200 hover:bg-green-100"
//                   }`}
//               >
...
const ExplorePage = () => {
  ...
  const filteredPlaces = useMemo(() => {
    ...
    //       ?.toLowerCase()
    //       .trim()
    //       .includes(selectedSub.toLowerCase().trim())
    //   );
    // }
